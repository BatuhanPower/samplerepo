...
import 'LightComponentHeaderLabel.dart';
        ...
        class NavigationDrawerslSide extends StatelessWidget {
          const NavigationDrawerslSide({Key key}) : super(key: key);    
          ...
          Widget build(BuildContext context) {
            ...
            child: Column(
                ...
                children: <Widget>[Align(alignment: Alignment.centerLeft, child: Text('Side',style: GoogleFonts.roboto(fontSize: 20.0, color: AppColors.Dark 🌑 / On Primary / High Emphasis #000000.withOpacity(0.6), letterSpacing: 0.15000000953674317, fontWeight: FontWeight.w500, height: 1.2, ),textHeightBehavior: TextHeightBehavior(applyHeightToFirstAscent: false),),),const LightNavDrawer1GroupASide(),],
            ),
        ),Align(alignment: Alignment.bottomCenter, child: const LightNavDrawer1GroupASide(),),],
            ),
